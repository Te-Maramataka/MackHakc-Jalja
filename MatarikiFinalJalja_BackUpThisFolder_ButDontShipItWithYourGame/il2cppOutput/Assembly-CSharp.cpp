...
IL_001f:
	{
		// if (leftFingerId != -1)
		int32_t L_1 = __this->___leftFingerId_9;
...
IL_0035:
	{
		...
		float L_6 = __this->___halfScreenWidth_11;
	...
	{
		int32_t L_7 = __this->___leftFingerId_9;
...
IL_0071:
	{
		...
		float L_12 = __this->___halfScreenWidth_11;
	...
	{
		int32_t L_13 = __this->___rightFingerId_10;
	...
	}
	{
		...
		__this->___rightFingerId_10 = L_14;
		// break;
		goto IL_0166;
	}
...
IL_00a6:
	{
		...
		int32_t L_16 = __this->___leftFingerId_9;
...
IL_00cb:
	{
		...
		int32_t L_18 = __this->___rightFingerId_10;
...
IL_00f0:
	{
		...
		int32_t L_19;
		L_19 = Touch_get_fingerId_mC1DCE93BFA0574960A3AE5329AE6C5F7E06962BD((&V_1), NULL);
		int32_t L_20 = __this->___rightFingerId_10;
	...
	}
	{
		...
		float L_22 = __this->___cameraSensitivity_6;
		...
		L_25 = Vector2_op_Multiply_m4EEB2FF3F4830390A53CE9B6076FB31801D65EED_inline(L_23, L_24, NULL);
		__this->___lookInput_12 = L_25;
		goto IL_0166;
	}
...
IL_0123:
	{
		...
		int32_t L_26;
		L_26 = Touch_get_fingerId_mC1DCE93BFA0574960A3AE5329AE6C5F7E06962BD((&V_1), NULL);
		int32_t L_27 = __this->___leftFingerId_9;
	...
	}
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_29 = __this->___moveTouchStartPosition_14;
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_30;
		L_30 = Vector2_op_Subtraction_m664419831773D5BBF06D9DE4E515F6409B2F92B8_inline(L_28, L_29, NULL);
		__this->___moveInput_15 = L_30;
		// break;
		goto IL_0166;
	}
...
IL_014c:
	{
		// if (t.fingerId == rightFingerId)
		int32_t L_31;
		L_31 = Touch_get_fingerId_mC1DCE93BFA0574960A3AE5329AE6C5F7E06962BD((&V_1), NULL);
		int32_t L_32 = __this->___rightFingerId_10;
...
IL_016a:
	{
		...
		int32_t L_35 = V_0;
		int32_t L_36;
		L_36 = Input_get_touchCount_m7B8EAAB3449A6DC2D90AF3BA36AF226D97C020CF(NULL);
...
IL_0014:
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_3 = (&__this->___moveInput_15);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_4;
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_9 = __this->___characterController_5;
		...
		NullCheck(L_9);
		int32_t L_21;
		L_21 = CharacterController_Move_mE3F7AC1B4A2D6955980811C088B68ED3A31D2DA4(L_9, L_20, NULL);
		// }
		return;
	}
}
...
IL_000d:
	...
	}
	{
		...
		int32_t L_5 = V_1;
		DateTime__ctor_mA3BF7CE28807F0A02634FD43913FAAFD989CEE88((&V_0), L_4, 6, L_5, NULL);
		// Date = FirstFriday(Date); //find closest friday
		DateTime_t66193957C73913903DDAD89FEDC46139BCA5802D L_6 = V_0;
		DateTime_t66193957C73913903DDAD89FEDC46139BCA5802D L_7;
		L_7 = algorithm_FirstFriday_m58390DC68E5CFA83B2F906D408E6DFE3CAEFB355(L_6, NULL);
		V_0 = L_7;
		// break;
		goto IL_0038;
	}
...
IL_0038:
	{
		// if (Date.Month != 6){
		int32_t L_10;
		L_10 = DateTime_get_Month_m899C6602DE8198990B2CAF5EBC04CC67764E3DA2((&V_0), NULL);
...
IL_0046:
	{
		...
		DateTime__ctor_mA3BF7CE28807F0A02634FD43913FAAFD989CEE88((&L_13), L_11, 7, L_12, /*hidden argument*/NULL);
		bool L_14;
		L_14 = algorithm_IsCorrectMoonPhase_m7C8DB7992BEF214C656A064E6A509B63AF110F78(L_13, NULL);
		if (!L_14)
		{
			goto IL_0068;
		}
	}
	{
		...
		int32_t L_16 = V_2;
		DateTime__ctor_mA3BF7CE28807F0A02634FD43913FAAFD989CEE88((&V_0), L_15, 7, L_16, NULL);
		// Date = FirstFriday(Date); //find closest friday
		DateTime_t66193957C73913903DDAD89FEDC46139BCA5802D L_17 = V_0;
		DateTime_t66193957C73913903DDAD89FEDC46139BCA5802D L_18;
		L_18 = algorithm_FirstFriday_m58390DC68E5CFA83B2F906D408E6DFE3CAEFB355(L_17, NULL);
		V_0 = L_18;
		// break;
		goto IL_0071;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool algorithm_IsCorrectMoonPhase_m7C8DB7992BEF214C656A064E6A509B63AF110F78 (DateTime_t66193957C73913903DDAD89FEDC46139BCA5802D ___Date0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		double L_4 = V_0;
		V_0 = ((double)il2cpp_codegen_add(L_4, (152.0)));
	...
	}
	{
		...
		double L_6 = V_0;
		int32_t L_7;
		L_7 = DateTime_get_Day_m872DBCA4C79955EC1E27EB68746B6C2F6A183B28((&___Date0), NULL);
		V_0 = ((double)il2cpp_codegen_add(L_6, ((double)L_7)));
		goto IL_0091;
	}
...
IL_0050:
	{
		...
		V_0 = ((double)il2cpp_codegen_add(L_8, ((double)((int32_t)il2cpp_codegen_add(L_9, ((int32_t)30))))));
		goto IL_0091;
	}
...
IL_0060:
	{
		...
		double L_10 = V_0;
		V_0 = ((double)il2cpp_codegen_add(L_10, (151.0)));
		// if (Date.Month == 6){ //if month is june
		int32_t L_11;
		L_11 = DateTime_get_Month_m899C6602DE8198990B2CAF5EBC04CC67764E3DA2((&___Date0), NULL);
	...
	}
	{
		...
		double L_12 = V_0;
		int32_t L_13;
		L_13 = DateTime_get_Day_m872DBCA4C79955EC1E27EB68746B6C2F6A183B28((&___Date0), NULL);
		V_0 = ((double)il2cpp_codegen_add(L_12, ((double)L_13)));
		goto IL_0091;
	}
...
IL_0083:
	{
		...
		double L_14 = V_0;
		int32_t L_15;
		L_15 = DateTime_get_Day_m872DBCA4C79955EC1E27EB68746B6C2F6A183B28((&___Date0), NULL);
		V_0 = ((double)il2cpp_codegen_add(L_14, ((double)((int32_t)il2cpp_codegen_add(L_15, ((int32_t)30))))));
	}
...
IL_0091:
	{
		...
		double L_16 = V_0;
		V_0 = ((double)il2cpp_codegen_subtract(L_16, (9.5373530735600003)));
		// days -= 5; // subtract 5 for jan 5
		double L_17 = V_0;
		V_0 = ((double)il2cpp_codegen_subtract(L_17, (5.0)));
		// double currentPhase = days % 29.53058770576;
		double L_18 = V_0;
		V_1 = (fmod(L_18, (29.530587705759999)));
	...
	{
		double L_20 = V_1;
		if ((!(((double)L_20) <= ((double)(7.3826470375061035)))))
		{
			goto IL_00cf;
		}
	}
...
IL_002b:
	{
		...
		L_5 = DateTime_AddDays_m9DC06105845A82FEAF697D5E30308ABD49E5721B((&V_3), (-1.0), NULL);
		V_3 = L_5;
		// counterMinus += 1;
		int32_t L_6 = V_1;
...
IL_0040:
	{
		...
		int32_t L_7;
		L_7 = DateTime_get_DayOfWeek_mAC680139BCAA1613FC134454D1AD1B502CB1BB68((&V_3), NULL);
...
IL_000e:
	...
	{
		// if (useCursor)
		bool L_4 = __this->___useCursor_7;
		if (!L_4)
		{
			goto IL_0057;
		}
...
IL_0057:
	{
		...
		ARRaycastManager_tD9459374F0F5BD9E2E4A8A1C665E7F33F9C2EE44* L_12 = __this->___raycastManager_6;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_19 = __this->___objectToPlace_5;
		...
		L_28 = Object_Instantiate_TisGameObject_t76FEDD663AB33C991A9C9A23129337651094216F_m2537AA64AEAC12995F52F5B412866556B83CFBE0(L_19, L_23, L_27, Object_Instantiate_TisGameObject_t76FEDD663AB33C991A9C9A23129337651094216F_m2537AA64AEAC12995F52F5B412866556B83CFBE0_RuntimeMethod_var);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SoundManager_OnMusicButtonPress_m3B932B928CFC63E5488C687DCBC1B34C34B517AA (SoundManager_tCA2CCAC5CDF1BA10E525C01C8D1D0DFAC9BE3734* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		// BGM.Pause();
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_1 = __this->___BGM_8;
		NullCheck(L_1);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SoundManager_UpdateMusicButtonImage_mF4C0D3C4710809BEF75ADB45F9218C016B797D6B (SoundManager_tCA2CCAC5CDF1BA10E525C01C8D1D0DFAC9BE3734* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_1 = __this->___SoundOnImage_4;
		NullCheck(L_1);
		Behaviour_set_enabled_mF1DCFE60EB09E0529FE9476CA804A3AA2D72B16A(L_1, (bool)1, NULL);
		// SoundOffImage.enabled = false;
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_2 = __this->___SoundOffImage_5;
		NullCheck(L_2);
...
IL_0021:
	{
		...
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_3 = __this->___SoundOnImage_4;
		NullCheck(L_3);
		Behaviour_set_enabled_mF1DCFE60EB09E0529FE9476CA804A3AA2D72B16A(L_3, (bool)0, NULL);
		// SoundOffImage.enabled = true;
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_4 = __this->___SoundOffImage_5;
		NullCheck(L_4);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SoundManager_OnSFXButtonPress_mC2F3004ED993FC2360C395A74B7AEDFE0E534632 (SoundManager_tCA2CCAC5CDF1BA10E525C01C8D1D0DFAC9BE3734* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		// SFX.mute = !SFX.mute;
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_1 = __this->___SFX_9;
		...
		NullCheck(L_1);
		AudioSource_set_mute_m6407E0AEE7F088AC69BD8C1D270C2B2049769B09(L_1, (bool)((((int32_t)L_3) == ((int32_t)0))? 1 : 0), NULL);
		goto IL_004a;
	}
...
IL_002a:
	{
		...
		// SFX.mute = !SFX.mute;
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_4 = __this->___SFX_9;
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_5 = __this->___SFX_9;
		NullCheck(L_5);
		bool L_6;
		L_6 = AudioSource_get_mute_mE23745FC15F1105556CB7590CA651628FC562DBD(L_5, NULL);
		NullCheck(L_4);
		AudioSource_set_mute_m6407E0AEE7F088AC69BD8C1D270C2B2049769B09(L_4, (bool)((((int32_t)L_6) == ((int32_t)0))? 1 : 0), NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SoundManager_UpdateSFXButtonImage_m0196D39AD86C2EFFA0F41B0DD2FF3734E9A7A900 (SoundManager_tCA2CCAC5CDF1BA10E525C01C8D1D0DFAC9BE3734* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_1 = __this->___SFXOnImage_6;
		NullCheck(L_1);
		Behaviour_set_enabled_mF1DCFE60EB09E0529FE9476CA804A3AA2D72B16A(L_1, (bool)1, NULL);
		// SFXOffImage.enabled = false;
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_2 = __this->___SFXOffImage_7;
		NullCheck(L_2);
		Behaviour_set_enabled_mF1DCFE60EB09E0529FE9476CA804A3AA2D72B16A(L_2, (bool)0, NULL);
		return;
	}
...
IL_0021:
	{
		...
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_3 = __this->___SFXOnImage_6;
		NullCheck(L_3);
		Behaviour_set_enabled_mF1DCFE60EB09E0529FE9476CA804A3AA2D72B16A(L_3, (bool)0, NULL);
		// SFXOffImage.enabled = true;
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_4 = __this->___SFXOffImage_7;
		NullCheck(L_4);
		Behaviour_set_enabled_mF1DCFE60EB09E0529FE9476CA804A3AA2D72B16A(L_4, (bool)1, NULL);
		// }
		return;
